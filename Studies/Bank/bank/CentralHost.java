...
public class CentralHost {
	...
	/*@ spec_public @*/ static final int maxAccountNumber = 10000;

	/**
	 * All accounts existing for this bank. For simplicity, here just an array is
	 * used to implement a map from account number the <code>PermanentAccount</code>
	 * objects. In practice this should rather be a hashmap or something similar
	 */
	/*@
      ...
      @*/
	private /*@ spec_public @*/ final PermanentAccount[] accounts = new PermanentAccount[maxAccountNumber];
	...
	/**
	 * Issue a bank card for the account with number <code>accountNumber</code> and
	 * setup the card with the given PIN
	 * 
