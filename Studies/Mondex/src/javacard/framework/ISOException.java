...
public class ISOException extends CardRuntimeException  {
   ...
   /*@ static invariant \is_initialized(ISOException); @*/
   /*@ static invariant _systemInstance != null; @*/
   private /*@ spec_public @*/ static ISOException _systemInstance;

   /*@ exceptional_behavior
        requires true;
	signals (ISOException ie) ie == _systemInstance && ie._reason[0] == reason ;
