...
{
    protected /*@ spec_public @*/Point m_pos;          // position of this bounding box
    protected /*@ spec_public @*/Point m_size;         // size of this bb.
    protected /*@ spec_public @*/Point m_center;       // center of this bb.
    protected /*@ spec_public @*/Point[] m_bounds;     // calculated values of this bb. These are calculated by virtual function.
    protected /*@ spec_public @*/int m_radius;     // max radius of this object
    ...
    //@ post \result == this.m_pos;
    public /*@pure@*/Point getPos()
    {
        return m_pos;
    }
    
    //@ post \result == this.m_size;
    public Point getSize()
    {
        return m_size;
    }

    //@ post \result == this.m_bounds[index];
    public Point getBound(int index)
    {
        return m_bounds[index];
    }
    
    //@ ensures \result == this.m_center;
    public Point getCenter()
    {
        return m_center;
    }
    
    //@ ensures \result == this.m_radius;
    public /*@pure@*/int getRadius() // WARN ME: use center in this calculation
    {
        return m_radius;
    }
    
    //@ ensures (m_center.x == x) && (m_center.y == y);
