...
public class Bomb extends FallingObject
{
    ...
    public void draw(/*@ nullable @*/Graphics g, int x, int y)
    {
        ...
        {
            g.setClip(0, 0, m_game_state.getWidth(), clip_y);
        ...
        if (clip_y - iy  < Common.ceilInt(getRadius()))
        {
            g.setClip(0, clip_y + 1, m_game_state.getWidth(), m_game_state.getHeight() - (clip_y + 1));
    ...
    //@ also
    //@ post m_state == DESTROYED;
    void onCollision(/*@ nullable @*/GameObject go)
    {
