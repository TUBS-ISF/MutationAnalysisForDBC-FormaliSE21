...
public class IntroGameHandler extends BasicGameHandler
{
    ...
    private /*@ nullable @*/Plane     m_plane;
    ...
    public IntroGameHandler(GameState gs) throws Exception
    {
        ...
        m_menu = new String[7];
        buildMenu();
        m_game_state.setScreenOptions(m_game_state.getResourceManager().
                                      getBomberTitle().getHeight(0),
                                      m_game_state.getResourceManager().
                                      getBomberTitle().getHeight(1));
    }
...
// ==========================================================================;
    ...
    public void draw(Graphics g, int x, int y)
    {
            ...
            m_game_state.getResourceManager().getBomberTitle().drawImage(g, 1, 0, m_game_state.getHeight() - h);   // draw empty banner
