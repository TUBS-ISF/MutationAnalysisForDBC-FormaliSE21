...
public abstract class GameObject implements Visual
{
    ...
    protected /*@ spec_public @*/byte              m_state;
    ...
    abstract void collided(/*@ nullable @*/GameObject go, int delta);  // reports that object has collided with specific object
    abstract void collidedTerrain(/*@ nullable @*/Terrain terrain,
                                  boolean water,
    ...
    abstract /*@nullable@*/BoundingBox getBoundingBox();              // gets bounding box of this object (or null, if it does not exist)
    ...
    public boolean checkCollision(/*@ nullable @*/GameObject go)
    {
    ...
    public abstract void draw(/*@ nullable @*/Graphics g, int x, int y);

    public abstract int handle(int delta);
