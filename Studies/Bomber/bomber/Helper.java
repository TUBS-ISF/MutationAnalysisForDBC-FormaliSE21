...
// ==========================================================================;
    ...
    {
        // Store current clip (should be full screen)
        int cx, cy, cw, ch;
        cx = g.getClipX();
        cy = g.getClipY();
        cw = g.getClipWidth();
...
// ==========================================================================;
    ...
    public static void drawIconAboveObject(Graphics g,/*@ nullable @*/ GameObject go, Drawable icon, int index, int x, int y)
    {
            icon.drawImage(g, index, Common.toInt(go.getPos().x - x), Common.toInt(go.getPos().y - y - go.getRadius()));
    }


    public static void drawIndicator(Graphics g, int x, int y, /*@ nullable @*/GameObject go, int s_x, int s_y, int s_x1, int s_y1)
    {
