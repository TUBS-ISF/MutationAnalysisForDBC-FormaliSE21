...
public class MissionGameHandler extends BasicGameHandler
{
    ...
    protected /*@ nullable @*/Plane        m_control;           // plane under player's control
    ...
    {
        init(gs);
        int score_board_height = m_game_state.getResourceManager().getScoreBoard().getHeight(0);
        m_score_board_height = m_game_state.getHeight() - score_board_height;
        m_game_state.setScreenOptions(0, score_board_height);
        m_targets = targets;
