...
public class Zeppelin extends GameObject implements CanTarget
{
    ...
    public void draw(/*@ nullable @*/Graphics g, int x, int y) 
    {
        g.setColor(0);
    ...
    //@ also
    //@ pre true;
    //@ post \result == m_bounds.getRadius();
    int getRadius() 
    {
    ...
    //@ also
    //@ ensures \result == m_bounds.getPos();
    Point getPos() 
    {
    ...
    //@ also
    //@ ensures \result == (COLLIDABLE | TERRAIN_DAMAGE | BOUNDS_DETECT | CAN_TARGET);
    short getType() 
    {
    ...
    public void setTarget(/*@ nullable @*/GameObject go)
    {
        m_target = go;
    }
    ...
    void collided(/*@ nullable @*/GameObject go, int delta) 
    {
    ...
    void collidedTerrain(/*@ nullable @*/Terrain terrain, boolean water, int delta)
    {
    ...
    //@ also
    //@ ensures \result == Common.toFP(100);
