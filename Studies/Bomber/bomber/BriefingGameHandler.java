...
public class BriefingGameHandler extends BasicGameHandler
{
    ...
    protected /*@ spec_public @*/String[]  m_message;

    protected int       m_object_index;
    protected /*@ spec_public @*/int      m_timer;
    ...
    protected /*@ spec_public @*/byte     m_message_index;
    ...
    public BriefingGameHandler(GameState gs, String[] message, GameObject[] objects)
    {
        ...
        m_objects = objects;
        m_object_index = 0;
        //m_game_state.setScreenOptions(0, 30);
        m_game_state.setScreenOptions(30, 30);
    ...
    //@ also
    //@ requires delta >= 0;
    //@ ensures m_timer ==  \old( m_timer + delta);
    ...
    //@ ensures (\result == true) <==> (m_message_index == m_message.length - 1);
    //@ ensures (\result == false) <==> !(m_message_index == m_message.length - 1);
