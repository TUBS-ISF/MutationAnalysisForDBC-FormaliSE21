...
public  /* nullable_by_default */class  Blind {
  ...
  /** The big. */
  private /*@ spec_public @*/int big;

	

  /** The small. */
  private /*@ spec_public @*/int small;

	

  /** The ante. */
  private/*@ spec_public @*/int ante;
  ...
  /*@ public normal_behavior
    ...
    */
  public Blind(final double smallBlind, final int bigBlind,
   ...
   */
  public final void setAnte(final int newAnte) {
    this.ante = newAnte;
    // assert false;
    //assert false;
  }
  ...
  /*@ public normal_behavior
      ...
      ensures big == newBig;
   */
  public final void setBig(final int newBig) {
    this.big = newBig;
    // assert false;
    //assert false;
  }
   ...
   */
  public final/*@ pure @*/int getSmall() {
    // assert false;
    //assert false;
    return small;
  }
   ...
   */
  public final void setSmall(final int newSmall) {
    this.small = newSmall;
    // assert false;
    //assert false;
  }
   ...
   */
  public final void increaseBlind(final int newSmallBlind,
      final int newBigBlind, final int newAnteSize) {
    setAnte(newAnteSize);
