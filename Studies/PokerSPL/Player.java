...
public  /* nullable_by_default */class  Player {
  ...
  /*@ requires newId > 0;
      ...
      ensures id == newId ;
   */
   private void  initPlayer__wrappee__Player  (final int newId, final int initAmount){
	  this.id = newId;
  }
   ...
   */
  private void initPlayer(final int newId, final int initAmount){
	  
	  initPlayer__wrappee__Player(newId,initAmount);
	  }
   ...
   */
  public final void addToBank(final int addValue) {
   ...
   */
  public final void call(final int callValue) {
   ...
   */
  public final void raise(final int betValue) {
  ...
  ensures bank == \old(getBank()) - addValue;
*/
  public final void subtractFromBank(final int value) {
   ...
   */
  public final void setBank(final int newBank) {
    this.bank = newBank;
