...
public class JavaCodeMutator implements IMutator {
	...
	public File[] generateMutants(File[] files) {
		...
		makeMuJavaStructure.makeDir(new File(home + File.separator + projectName));
		makeMuJavaStructure.makeDir(new File(home + File.separator + projectName + File.separator + sourceName));
