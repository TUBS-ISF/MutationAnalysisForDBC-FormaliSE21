...
public class JavaMethodCodeMutator implements IMutator {
	...
	public File[] generateMutants(File[] files) {
		...
		makeMuJavaStructure.makeDir(new File(MutationSystem.TRADITIONAL_MUTANT_PATH));
		makeMuJavaStructure.makeDir(new File(MutationSystem.CLASS_MUTANT_PATH));
		makeMuJavaStructure.makeDir(new File(MutationSystem.EXCEPTION_MUTANT_PATH));
...
//		}
		...
		makeMuJavaStructure.makeDir(new File(home + File.separator + "Persistence" + File.separator + projectName));
		makeMuJavaStructure.makeDir(new File(home + File.separator + "Persistence" + File.separator + projectName + File.separator + sourceName));
