...
public static void abcdefghijklmnopqrstuvwxyz0() {}
	
  //@ public invariant (cents() > 0 ==> dollars() >= 0) && (dollars() > 0 ==> cents() >= 0);
public static void abcdefghijklmnopqrstuvwxyz1() {}
	
  //@ public invariant (cents() < 0 ==> dollars() <= 0) && (dollars() < 0 ==> cents() <= 0);
public static void abcdefghijklmnopqrstuvwxyz2() {}
...
public  private  int my_dollars;
  //@ in dollars;
public static void abcdefghijklmnopqrstuvwxyz3() {}
  
  //@ public model int dollars;
public static void abcdefghijklmnopqrstuvwxyz4() {}
  
  //@ private represents dollars = my_dollars;
public static void abcdefghijklmnopqrstuvwxyz5() {}
  ...
  //@ in cents;
public static void abcdefghijklmnopqrstuvwxyz6() {}
  
  //@ public model int cents;
public static void abcdefghijklmnopqrstuvwxyz7() {}
  
  //@ private represents cents = my_cents;
public static void abcdefghijklmnopqrstuvwxyz8() {}
